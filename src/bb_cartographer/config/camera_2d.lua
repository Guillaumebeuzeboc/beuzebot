...
options = {
  ...
  pose_publish_period_sec = 0.01,--5e-3,
  trajectory_publish_period_sec = 0.02,--30e-3,
...
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(7.)
